...
export const ec0lintIsSection = {
  ...
  subtitle: "ec0lint is...",
  text:
    "...a tool for frontend developers that mitigates the " +
...
export const donateSection = {
  title: "Donate now",
  text:
    "We'd be thankful if you'd like to support our work by pressing the donate " +
...
export const featuresPage = {
  ...
  mainFeatures: [
    ...
    },
    {
      ...
      text:
        "Heavy library calls can be replaced by plain JS code or lighter libraries. In the case of axios - when all axios functions will be " +
  ...
  meetUs: [
    <span>
      <a
        className="link"
        href={
          "https://spolecznosc.ing.pl/-/Blog/Startup-zakodowany-na-zielone/ba-p/39931"
        }
        target="_blank"
      >
    ...
    <span style={{ marginTop: "10px" }}>
      <a
        className="link"
        href={
          "https://portal.gitnation.org/contents/digital-ecology-how-can-you-mitigate-the-carbon-footprint-of-websites"
        }
        target="_blank"
      >
        <span>
          ec0lint and sustainable websites in 5 minutes (React Day Berlin)
        </span>
      </a>
    ...
    <span style={{ marginTop: "10px" }}>
      <a
        className="link"
        href={"https://www.youtube.com/watch?v=Hy11T_eoUHg&t=6300s"}
        target="_blank"
      >
        <span>
          Digital ecology - How to mitigate carbon footprint of websites? (Full
          presentation during React India)
        </span>
      </a>
...
export const features = [
  {
    ...
    CO2: (
      <span>
        {
          "By using this rule in your project, you can reduce the carbon footprint even up to "
        }
        <u>0.5 g per website view</u>
        {
          " after removing the redundant library. By multiplying the library size by the end-user traffic (0.81 kWh / 1024 MB) and by the energy emissions (442 g/kWh), the carbon footprint of a library can be calculated."
        }
        ...
        {"The library sizes were checked at "}
        <a
          target="_blank"
          rel="noreferrer"
        ...
        {
          " For more examples how to replace lodash with plain javascript go here: "
        }
        <a
          target="_blank"
          rel="noreferrer"
  ...
  },
  {
    ...
    CO2: (
      <span>
        ...
        {
          " For more examples how to replace date-fns with plain javascript go here: "
        }
        <a
          target="_blank"
          rel="noreferrer"
          href="https://youmightnotneed.com/date-fns"
          className="link"
        >
  ...
  },
  {
    ...
    CO2: (
      <span>
        ...
        {
          " For more examples how to replace moment-js with plain javascript go here: "
        }
        <a
          target="_blank"
          rel="noreferrer"
  ...
  },
  {
    ...
    CO2: (
      <span>
        {
          "Convertion of only one of the most popular fonts used on websites – Helvetica Neue - from TTF to WOFF2 format can reduce the carbon footprint even up to "
        }
        <u>0.54 g per website view.</u>
        {" By converting the same file to WOFF format we achieve "}
        <u>0.35 g</u>
        {" CO2 reduction."}
        {
        ...
        {"TTF font file sizes were checked at "}
        <a
          target="_blank"
          rel="noreferrer"
        ...
        {" and converted to WOFF and WOFF2 formats on "}
        <a
          target="_blank"
          rel="noreferrer"
    ...
    examples:
      "@font-face { font-family: 'foo'; src: url('/path/to/foo.ttf'); } - Unrecommended format of the file \n\n" +
  ...
  },
  {
    ...
    CO2: (
      <span>
        ...
        <u>0.21 g per website view</u>
        {" after removing a redundant library.\n\n"}
        {
        ...
        {
          ". For more examples how to replace axios or other http library with plain javascript go here: "
        }
        <a
          target="_blank"
          rel="noreferrer"
          href="https://danlevy.net/you-may-not-need-axios/"
          className="link"
        >
  ...
  },
  {
    ...
    CO2: (
      <span>
        Convertion of an exemplary image in 1800 x 1200 resolution from PNG to
        SVG format can reduce the carbon footprint by about{" "}
        <u>5.79 g CO2 per website view.</u>
        {
        ...
        <a
          target="_blank"
          rel="noreferrer"
          href="https://wallpaperaccess.com/1800x1200-hd"
          className="link"
        >
          https://wallpaperaccess.com/1800x1200-hd
        </a>
        {" and converted to different formats using "}
        <a
          target="_blank"
          rel="noreferrer"
          href="https://cloudconvert.com/"
  ...
  },
  {
    ...
    overview: (
      <span>
        ...
        {
          "The font-display property supports five different values: “auto”, “block”, “swap”, “fallback”, “optional”, each describing a different method of behaviour for different scenarios. In short, it allows fine control over whether a fallback font is used immediately, and what should happen after the custom font has loaded. "
        }
      </span>
    ),
    examples:
  ...
  },
  {
    ...
    CO2: (
      <span>
        {
          "By using lazy loading no unnecessary images and videos are transferred. For the file that isn’t displayed by a website user, we reduce CO2 emissions related to loading the file to 0 g.\n\n"
        }
        {
    ...
    examples:
      "The following patterns are considered as problems: \n\n" +
  ...
  },
  {
    ...
    CO2: (
      <span>
        ...
        {"Link to the exemplary video: "}{" "}
        <a
          target="_blank"
          rel="noreferrer"
          href="https://www.pexels.com/video/alpaca-closeup-5795043"
          className="link"
        >
          https://www.pexels.com/video/alpaca-closeup-5795043
        </a>
        <table className="table">
          <tbody>
            <tr>
          ...
          <caption style={{ captionSide: "bottom" }}>
            Converting the video from MP4 to WebM format can reduce the carbon
            footprint by 1.15 g of CO2 per website view.{" "}
          </caption>
        </table>
        {
          "By multiplying the file size by the end-user traffic (0.81 kWh /1024MB) and by thy energy emissions (442 g / kWh), the carbon footprint of the exemplary video in MP4 sums up to 2.06 g. The same file in WebM format generates 0.91 g of CO2. So, by subtracting 0.91 g from 2.06 g, we get "
        }
        <u>1.15 g (56% less CO2)</u>
        ...
        {"and converted to WebM online with "}
        <a
          target="_blank"
          rel="noreferrer"
    ...
    overview: (
      <span>
        ...
        <a
          target="_blank"
          rel="noreferrer"
          href="https://api.jquery.com/jQuery.get"
          className="link"
        >
          /$.get
        </a>
        <a
          target="_blank"
          rel="noreferrer"
          href="https://api.jquery.com/jQuery.getJSON/"
          className="link"
        >
          /$.getJSON
        </a>
        <a
          target="_blank"
          rel="noreferrer"
          href="https://api.jquery.com/jQuery.getScript/"
          className="link"
        >
          /$.getScript
        </a>
        <a
          target="_blank"
          rel="noreferrer"
          href="https://api.jquery.com/jQuery.post"
          className="link"
        >
          /$.post
        </a>
        {" utilities. We recommend using Window.fetch. \n\n"}
        {
  ...
  },
  {
    ...
    overview: (
      <span>
        {"Disallows to use global ajax events handlers: "}
        <a
          target="_blank"
          rel="noreferrer"
          href="https://api.jquery.com/ajaxComplete"
          className="link"
        >
          .ajaxComplete/
        </a>{" "}
        <a
          target="_blank"
          rel="noreferrer"
          href="https://api.jquery.com/ajaxError"
          className="link"
        >
          .ajaxError/
        </a>{" "}
        <a
          target="_blank"
          rel="noreferrer"
          href="https://api.jquery.com/ajaxSend"
          className="link"
        >
          .ajaxSend/
        </a>{" "}
        <a
          target="_blank"
          rel="noreferrer"
          href="https://api.jquery.com/ajaxStart"
          className="link"
        >
          .ajaxStart/
        </a>{" "}
        <a
          target="_blank"
          rel="noreferrer"
          href="https://api.jquery.com/ajaxStop"
          className="link"
        >
          .ajaxStop/
        </a>{" "}
  ...
  },
  {
    ...
    CO2: (
      <span>
        ...
        {
          " which lasts only 2 minutes, in the resolution of 720p (HD), has the file size of 14.7 MB.\n\nTo calculate the carbon footprint of a YouTube video file, we multiply the size of the video (14.7 MB) by the end-user traffic (0.81 kWh/1024 MB) and by the energy emissions (442 g/kWh), which sums up to "
        }
        <u>5.14 g of CO2</u>
        {". "}
      </span>
  ...
  },
  {
    ...
    overview: (
      <span>
        {
          "Disallows importing web fonts by @import and @font-face CSS rules. We recommend using system or locally hosted fonts.\n\nSystem fonts are automatically installed in every operating system of any device, which is used to display a website. Even if you don’t like system fonts, you can add a static font file (we recommend WOFF2, see: "
        }
        <a
          target="_blank"
          rel="noreferrer"
          href="https://ec0lint.com/features/no-ttf-font-files"
          className="link"
        >
          https://ec0lint.com/features/no-ttf-font-files
        </a>
        {
          ") to your website. All additional server requests and data transfer related to fonts can be saved. "
        }
      </span>
    ),
    CO2: (
      <span>
        {
          "By using system fonts or fonts hosted locally, you do not import any data from an external server. If you choose Arial (system font) instead of Arimo (web font, Arial equivalent from Google Fonts) you can save up to "
        }
        <u>0.021 g CO2 per view</u>
        {
          ". To calculate the carbon footprint of a web font, the size of TTF font file can be multiplied by the end-user traffic (0.81 kWh/1024 MB) and by the energy emissions (442 g/kWh). "
        }
        <table className="table">
          <tbody>
            <tr>
  ...
  },
  {
    ...
    overview: (
      <span>
        ...
        <figure>
          <img
            src={efficientBackgroundFig1}
            alt="hexagon graph with rgb model"
            className="image"
          />
          <figcaption>
            Figure 1 - The recommended colors are inside the marked hexagon.
          </figcaption>
        </figure>
        {
          "How OLED displays work\n\nEach pixel of an OLED display emits three channels of color - red, green and blue. The luminance of the three colors is different. The black color does not emit light, so it is the least power-consuming color, whereas the white color has the maximum luminance, so it consumes the most power. More information: "
        }
        <a
          target="_blank"
          rel="noreferrer"
          href="https://www.hindawi.com/journals/misy/2016/6575931/"
          className="link"
        >
          https://www.hindawi.com/journals/misy/2016/6575931/
        </a>
        {"."}
      </span>
    ),
    CO2: (
      <span>
        ...
        <a
          target="_blank"
          rel="noreferrer"
          href="https://ieeexplore.ieee.org/abstract/document/5989813"
          className="link"
        >
          link
        </a>
        {
          " we can calculate the power consumption of OLED displays as a sum of power consumption of each RGB color of a pixel. Figure 1 shows the energy consumption of three RGB colors of different intensities on a μOLED-32028-P1 AMOLED display. Research: "
        }
        <a
          target="_blank"
          rel="noreferrer"
          ...
          className="link"
        >
          https://ieeexplore.ieee.org/abstract/document/5989813"
        </a>
        {"\n"}
        <figure>
          <img
            src={efficientBackgroundFig2}
            alt="graph of power consumption"
            className="image"
          />
          <figcaption>
            Figure 2 - Power consumption for the R, G, and B components of a
            pixel of OLED screen with different intensity levels.
          </figcaption>
        </figure>
        {
          "Based on the above figure we can see that the most power-consuming color is blue – this is why we decided to set in ec0lint a lower boundary value for blue color than for other two.\nIn order to reduce energy consumption we should use energy efficient color palettes. Examples: "
        }
        <a
          target="_blank"
          rel="noreferrer"
          href="https://greentheweb.com/energy-efficient-color-palette-ideas/"
          className="link"
        >
...
export const CO2Calculation = {
  ...
  intro:
    "Calculating greenhouse gas emissions of websites is difficult as many energy consuming components of the Internet " +
  ...
  formula: {
    title: "The formula",
    equasion:
      "Emissions of CO2 Per One Website Visit = (Data Transfer of the First Visit x 75% + Data Transfer of the Returning Visit x 25%) x Energy Emissions",
    description: {
      intro: "in which:",
      points: [
        {
          name: "Data Transfer of the First Visit",
          description: "Energy of The Website",
        },
        {
          name: "Data Transfer of the Returning Visit",
          description: "Energy of The Webpage x 2% ",
        },
        {
          name: "Energy of The Webpage",
          description: "Webpage Size x End-User Traffic",
        },
    ...
    footNote:
      "Having this formula makes the CO2 estimation very easy, as the only parameter we need to know is the size of a website. ec0lint calculates it " +
  ...
  finalRemarks: {
    title: "Final remarks",
    text:
      "The amount of carbon emissions per energy unit varies in each region. If you want to know what's the number of CO2 for a" +
    ...
    <span>
      ...
      <ul>
        ...
        <li>
          ...
          refers to ec0lint, that is responsible for your information under this
          Privacy Policy.
        </li>
        <li>
          Country: where ec0lint or the owners/founders of ec0lint are based, in
          this case is Poland.
        </li>
        <li>
          Customer: refers to the company, organization or person that signs up
          to use the ec0lint Service to manage the relationships with your
          consumers or service users.
        </li>
        <li>
          Device: any internet connected device such as a phone, tablet,
          computer or any other device that can be used to visit ec0lint and use
          the services.
        </li>
        <li>
        ...
        <li>
          Personnel: refers to those individuals who are employed by ec0lint or
        ...
        <li>
          Service: refers to the service provided by ec0lint as described in the
        ...
        <li>
          Website: ec0lint."'s" site, which can be accessed via this URL:
          ec0lint.com.
        </li>
        <li>
          You: a person or entity that is registered with ec0lint to use the
          Services.
        </li>
      </ul>
  ...
  text: (
    <span>
      ...
      <ul>
        ...
        <li>
          {
            "Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to ec0lint, that is responsible for your information under this Terms & Conditions."
          }
        </li>
        <li>
          Country: where ec0lint or the owners/founders of ec0lint are based, in
        ...
        <li>
          {
            'Website: ec0lint."\'s" site, which can be accessed via this URL: ec0lint.com.'
          }
        </li>
        <li>
          You: a person or entity that is registered with ec0lint to use the
      ...
      <ul>
        ...
        <li>
          ...
          of copyright or trademark) of ec0lint or its affiliates, partners,
...
export const useCases = {
  title:
    "But hey, for now, you can learn why we designed our website the way we did.",
  bulletPoints: [
    {
      title: "Colors",
      text:
        "You don't have to increase the screen brightness wasting your battery " +
        "and computing energy as we used high contrasting colors.",
    },
    {
      title: "Fonts",
      text:
        "We used only one font hosted online, namely Fibra Code, and saved " +
    ...
    },
    {
      title: "Hosting",
      text:
        "The hosting provider we chose, Krystal, uses renewable energy to power its servers and " +
  ...
  posts: [
    ...
    },
    {
      ...
      text: [
        ...
        <h6>
          Did you know that 250 000 new websites are being published every day?
          We find it crazy. According to our research, an average website with
          10 000 views every month generates 1.8 g of carbon dioxide per view.
          This sums up to 216 kg of CO2 annually. And this number is valid only
          for one single website.
        </h6>,
        <h6>
          {
        ...
        <h6>
          Frontend developers use daily a tool called ESlint. It shows comments
          that something is missing in the code. For example, it tells you to
          add a semi-comma. This tool is well-known in the programming world and
          thus, we used this concept for building our tool.
        </h6>,
        <h5 style={{ color: "#8ECCEA" }}>So, what exactly is ec0lint?</h5>,
        <h6>
          ec0lint is a tool for frontend developers that helps in mitigating the
          carbon footprint of websites. You can use it already during the coding
          process to prevent a carbon-heavy web page from publishing. ec0lint
          advices you on what to change in your code to minimize the size of
          different components. For example, if you change the font format from
          TOFF to WOFF you save up to 75% of space. The font will look exactly
          the same for the end-users, but you'll know. It is all about
          minimizing the space taken by various elements of the website. In our
          next article, you'll learn how to precisely calculate the carbon
          emissions of a website.
        </h6>,
        <h6>
          Hey, but how many grams of carbon dioxide are we exactly talking
          about? Thanks to code optimization we can help in reducing CO2
          emissions per one view from 1.8 g to ~0.2 g so to only 24 kg CO2 per
          website annually, saving 216 kg CO2 (-96%!).{" "}
        </h6>,
        <h6>
          We're already dreaming of the near future when we'll optimize the
          process so that a programmer could by one click change the whole
          website to its eco-friendly version. And this isn't the end. After we
          finish ec0lint we want to take a closer look at WordPress and develop
          a suitable plugin.
        </h6>,
        <h5 style={{ color: "#8ECCEA" }}>
          We hope that you'll learn a lot from us and that most of you will use
          ec0lint on a day-to-day basis.
        </h5>,
      ],
    },
    {
      ...
      text: [
        <h6>
          We always knew that my online activities impact climate change, but as
          their consequences are invisible, I kept on ignoring the topic.
          Exactly one year ago, we started learning more about digital pollution
          and discovered the term digital ecology. In this article, we want to
          share with you tips and tricks on how to act against internet
          pollution on a day-to-day basis.
        </h6>,
        <h6>
          <h5 style={{ color: "#8ECCEA" }}>1. Deceitful videos</h5>
          <ul>
            <li>
              Videos account for 1% of global emissions consuming the same
              amount of energy as Spain. If it's possible, block the automatic
              playing of videos.{" "}
            </li>
            <li>
              According to the International Energy Agency (IEA), watching
              Netflix for an hour entails 36 g of CO2. Watching films in lower
              definition reduces data traffic significantly and thus, lowers the
              amount of energy needed to power the platform. This works for
              other platforms like YouTube. Alternatively, you can opt for
              downloading a video.{" "}
            </li>
            <li>
              Video conferencing can be more eco-friendly if you switch off your
              camera.
            </li>
          </ul>
        </h6>,
        <h6>
          <h5 style={{ color: "#8ECCEA" }}>2. Email, a snake in the grass </h5>
          <ul>
            <li>
              An email stored in an email account emits 19 g of CO2 annually.
              So, open up your mailbox and delete unnecessary emails.
            </li>
            <li>
              Whenever possible, avoid sending emails. Use an internal messaging
              tool that consumes less energy. Slack, for example. You can also
              switch to SMS - sending one email generates on average 4 g of CO2
              whereas an old-fashioned SMS only 0.014 g.
            </li>
            <li>
              Try using an anti-spam tool. For instance, download Cleanfox to
              unsubscribe from all newsletters you don't read.
            </li>
            <li>
              When sending an attachment, compress the file first or send it as
              a download link. You can try WeTransfer or Google Drive.
              Alternatively, think about using a USB.{" "}
            </li>
            <li>Remove images from your email signature.</li>
          </ul>
        </h6>,
        <h6>
          <h5 style={{ color: "#8ECCEA" }}>3. Vicious cycle of browsing</h5>
          <ul>
            <li>
              Close unused tabs as each web page that remains open is
              continuously connected to its server.{" "}
            </li>
            <li>
              When you want to visit a page which address you know by heart,
              write its address directly in the bar of a browser instead of in
              the search engine.{" "}
            </li>
            <li>Avoid repeating identical searches by using bookmarks.</li>
            <li>
              Utilize an eco-responsible web search engine like Ecosia or Lilo.{" "}
            </li>
            <li>
              Rethink your keywords. The more precise you are, the more energy
              you save.{" "}
            </li>
            <li>
              Remember to erase old media on your social platforms from time to
              time.{" "}
            </li>
          </ul>
        </h6>,
        <h6>
          <h5 style={{ color: "#8ECCEA" }}>4. Casting a cloud on the cloud </h5>
          <ul>
            <li>
              One hundred zettabytes of data will be stored in the cloud by 2025
              and such online storage solutions consume a lot of energy. Try
              periodically deleting data from your cloud or favor storing them
              on an external hard drive instead.{" "}
            </li>
            <li>
              Before choosing a cloud service, get familiar with the company's
              mission and opt for the most environmental-friendly choice.{" "}
            </li>
          </ul>
        </h6>,
        <h6>
          <h5 style={{ color: "#8ECCEA" }}>5. Criminal cryptocurrency</h5>
          <ul>
            <li>
              According to researchers from the University of Cambridge, bitcoin
              uses 0.21% of the world's energy supply according. Have you ever
              heard of Cardano which claims to be 37,500 times more
              energy-efficient than Bitcoin? How about Solarcoin?{" "}
            </li>
          </ul>
        </h6>,
        <h6>
          <h5 style={{ color: "#8ECCEA" }}>
            6. Your devices, perennial comrade
          </h5>
          <ul>
            <li>
              Changing smartphones or computers less often has a positive impact
              on the planet. Replacing computers every 6 years instead of 4
              saves 190 kg of CO2 emissions per person.{" "}
            </li>
          </ul>
        </h6>,
        <h6>
          <h5 style={{ color: "#8ECCEA" }}>7. Heavenly disconnecting</h5>
          <ul>
    ...
    },
    {
      ...
      text: [
        <h6>
          {
            "Do you want to more know about the sustainability of your website and your impact on digital pollution? This article is just for you. We're going to present you five web pages that are really absorbing. Go and check them out!"
          }
        </h6>,
        <h5 style={{ color: "#8ECCEA" }}>
          {"1) "}{" "}
        ...
        <h6>
          {
            "Beautifully designed, Thanks in Advance draws attention to our inboxes. Have you ever wondered if Earth's inbox is already full? Thanks in Advance explains the problem and encourages to take actions like managing newsletters or reducing file sizes. What we love the most is how sustainable the web page was designed and how well each step of the process was described."
          }
        </h6>,
        <h5 style={{ color: "#8ECCEA" }}>
          {"4)  "}{" "}
...
export const team = {
  ...
  contributors: [
...

    {
      ...
      github:
        "https://github.com/martinabab?fbclid=IwAR3mmVZVB-kI6jIP_w5wznkllt79Yd2W9paWrMSdIDPEKo4puoYoJMFjnWQ",
    },
  ],
  alumni: [
    {
      ...
      photo: (
        <img src={Kasia} className="circlePhoto" alt="Katarzyna Wojdalska" />
      ),
    ...
    },
    {
      ...
      photo: (
        <img src={Ola} className="circlePhoto" alt="Aleksandra Borowska" />
      ),
...
export const initiativesSection = {
  ...
  modal: [
      ...
      link: (
        <span>
          ...
          <a
            ...
            target="_blank"
            href="https://digitalecology.institute"
            rel="noreferrer"
          >
            here
          </a>
    ...
    },
    {
      ...
      link: (
        <span>
          ...
          <a
            className="navLinkPurple"
            target="_blank"
            href="https://www.thinkcompany.fi/what-we-do/programs/think-company-fund-2022"
            rel="noreferrer"
          >
            here
          </a>
      ...
      image: (
        <>
          <img src={helsinki1} className="helsinki-image"></img>
          <img src={helsinki2}></img>
        </>
      ),
    },
    {
      ...
      link: (
        <span>
          ...
          <a
            className="navLinkPurple"
            target="_blank"
            href="https://www.ing.pl/o-banku/esg/program-grantowy"
            rel="noreferrer"
          >
            here
          </a>
          . In addition, ING wrote about us{" "}
          <a
            className="navLinkPurple"
            target="_blank"
            href="https://spolecznosc.ing.pl/-/Blog/Startup-zakodowany-na-zielone/ba-p/39931"
            rel="noreferrer"
          >
            here
          </a>
